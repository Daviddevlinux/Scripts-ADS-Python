# Automação das Atividades - Avaliação de Desempenho de Sistemas - Python 🐍
...
- Scripts de Automação: Scripts Python desenvolvidos para rodar simulações de desempenho de sistemas.
