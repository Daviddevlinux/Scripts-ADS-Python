...
for tamanho_entrada in TAMANHOS_ENTRADA:
    for algoritmo in ALGORITMOS:
        ...
        print(f"Executando {N} medições para {algoritmo} com tamanho de entrada {tamanho_entrada}")

        for i in range(1, N + 1):
            print(f"Medição {i} para {algoritmo} com tamanho {tamanho_entrada}...")
        ...
        print(f"Resultados para {algoritmo} com tamanho {tamanho_entrada} salvos no diretório {algoritmo_dir}")
